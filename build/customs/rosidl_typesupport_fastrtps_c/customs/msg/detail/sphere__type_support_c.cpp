...
#include "customs/msg/detail/sphere__rosidl_typesupport_fastrtps_c.h"
...
using _Sphere__ros_msg_type = customs__msg__Sphere;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = customs__msg__Sphere;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const customs__msg__Sphere * ros_message = static_cast<const customs__msg__Sphere *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_customs__msg__Sphere(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  customs__msg__Sphere * ros_message = static_cast<customs__msg__Sphere *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_customs__msg__Sphere(cdr, ros_message);
}

static uint32_t _Sphere__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_customs__msg__Sphere(
...
static size_t _Sphere__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_customs__msg__Sphere(
