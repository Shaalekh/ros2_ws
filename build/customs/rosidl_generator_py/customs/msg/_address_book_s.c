...
bool customs__msg__address_book__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("customs.msg._address_book.AddressBook", full_classname_dest, 37) == 0);
  }
  customs__msg__AddressBook * ros_message = _ros_message;
  {  // first_name
  ...
  {  // phone_type
    ...
    rosidl_runtime_c__String__assign(&ros_message->phone_type, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * customs__msg__address_book__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("customs.msg._address_book");
  ...
  {  // phone_type
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->phone_type.data,
      strlen(ros_message->phone_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
