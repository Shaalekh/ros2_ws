...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('customs')
        except ImportError:
            import logging
            import traceback
...
class AddThreeInts_Event(metaclass=Metaclass_AddThreeInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<customs/AddThreeInts_Request, 1>',
        'response': 'sequence<customs/AddThreeInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['customs', 'srv'], 'AddThreeInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['customs', 'srv'], 'AddThreeInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from customs.srv import AddThreeInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from customs.srv import AddThreeInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from customs.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from customs.srv._add_three_ints import AddThreeInts_Request as Request
    from customs.srv._add_three_ints import AddThreeInts_Response as Response
    from customs.srv._add_three_ints import AddThreeInts_Event as Event
